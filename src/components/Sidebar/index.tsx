...
import Logo from '../../images/logo/ls.png';
            ...
            {role === 'admin' ? (
              <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <NavLink
                          to="#"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/teachers' ||
                ...
                <li>
                  <NavLink
                    to="/diary"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('diary') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                ...
                <li>
                  <NavLink
                    to="/fees"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('fees') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                ...
                <li>
                  <NavLink
                    to="/attendence"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('attendance') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                ...
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/timetable' || pathname.includes('timetable')
                  }
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <NavLink
                          to="#"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/timetable' ||
                  ...
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <NavLink
                          to="#"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/stock' ||
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {/* <SidebarLinkGroup
                  activeCondition={
                    pathname === '/teacher/dashboard' || pathname.includes('/teacher/dashboard')
                  }
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <NavLink
                          ...
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/teacher/dashboard' ||
                            pathname.includes('dashboard')) &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                          onClick={(e) => {
                ...
                <li>
                  <NavLink
                    to="/teacher/selfattendance"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('marks') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                ...
                <li>
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('timetable') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                ...
                <li>
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('assignments') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                ...
                <li>
                  <NavLink
                    to="/teacher/leave"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('leave') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
